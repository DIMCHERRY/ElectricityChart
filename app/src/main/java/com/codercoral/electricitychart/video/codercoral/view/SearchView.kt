package com.codercoral.electricitychart.video.codercoral.view
...
class SearchView(context: Context, attrs: AttributeSet) : AppCompatEditText(context, attrs), View.OnFocusChangeListener, TextWatcher {
    ...
    private fun init(context: Context) {
        ...
        mClearDrawable = mContext!!.resources.getDrawable(R.mipmap.icon_close)
        //设置删除按钮的边界
